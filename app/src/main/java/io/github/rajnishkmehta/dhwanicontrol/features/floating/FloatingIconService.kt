...
class FloatingIconService : Service() {
    ...
    private fun attachFloatingIcon() {
    ...
    private fun buildForegroundNotification(): Notification {
        val stopServiceIntent = Intent(this, FloatingIconService::class.java).apply {
            action = Constants.ACTION_STOP_FLOATING_SERVICE
        }

        val stopPendingIntent = PendingIntent.getService(
            this,
            Constants.STOP_ACTION_REQUEST_CODE + 1, // Unique request code
            stopServiceIntent,
